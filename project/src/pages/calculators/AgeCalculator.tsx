  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600">Calculate your exact age in years, months, and days</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <p>2. Select the date you want to calculate your age on (default is today)</p>
              <p>3. Your exact age will be calculated automatically</p>
              <p>4. View your age in different units - years, months, days, weeks, and hours</p>
            </div>
          </div>
        </div>
      </div>
