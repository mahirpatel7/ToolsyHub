  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600">Calculate the difference between two dates</p>
      </div>
            ...
            {result && (
              <div className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 bg-white border border-gray-200 rounded-lg text-center">
                    <div className="text-2xl font-bold text-gray-900">{result.totalMinutes.toLocaleString()}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-white border border-gray-200 rounded-lg text-center">
                    <div className="text-xl font-bold text-gray-900">{result.totalSeconds.toLocaleString()}</div>
