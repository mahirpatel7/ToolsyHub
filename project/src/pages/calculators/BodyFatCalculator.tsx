...
const BodyFatCalculator = () => {
  ...
  const calculateBodyFat = () => {
    ...
    let neckCm = unit === 'metric' ? parseFloat(neck) : parseFloat(neck) * 2.54;
    let waistCm = unit === 'metric' ? parseFloat(waist) : parseFloat(waist) * 2.54;
    let hipCm = gender === 'female' ? (unit === 'metric' ? parseFloat(hip) : parseFloat(hip) * 2.54) : 0;
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600">Calculate your body fat percentage using the U.S. Navy method</p>
      </div>
