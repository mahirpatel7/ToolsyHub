...
const CalorieCalculator = () => {
  ...
  const calculateCalories = () => {
    ...
    let heightCm = unit === 'metric' ? parseFloat(height) : parseFloat(height) * 2.54;
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600">Calculate your daily calorie needs</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="mt-8 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-blue-700">calories/day at rest</div>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="text-sm text-green-700">calories/day to maintain weight</div>
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-red-50 rounded-lg">
                    <h4 className="font-semibold text-red-900 mb-2">Weight Loss</h4>
                    <div className="text-2xl font-bold text-red-600">{result.weightLoss}</div>
                    <div className="text-sm text-red-700">calories/day to lose 1 lb/week</div>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="font-semibold text-purple-900 mb-2">Weight Gain</h4>
                    <div className="text-2xl font-bold text-purple-600">{result.weightGain}</div>
                    <div className="text-sm text-purple-700">calories/day to gain 1 lb/week</div>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">About the Calculator</h3>
