...
const WordToPDF = () => {
  ...
  const handleConvert = async () => {
    ...
    const originalFileName = file.name.replace(/\.[^/.]+$/, ''); // ✅ Remove .doc/.docx
    ...
    try {
      ...
      a.href = url;
      a.download = `${originalFileName}.pdf`; // ✅ Use original name for download
      a.click();
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p>
                <strong>Input:</strong> DOC, DOCX files
              </p>
              <p>
