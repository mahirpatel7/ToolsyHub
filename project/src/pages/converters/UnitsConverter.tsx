...
const UnitsConverter = () => {
  const [category, setCategory] = useState<'length' | 'weight' | 'temperature' | 'area' | 'volume' | 'time'>('length');
              ...
              <div className="mt-6 p-4 bg-teal-50 rounded-lg">
                <div className="text-center">
                  <div className="text-lg font-semibold text-teal-900">
                    {fromValue} {units[category][fromUnit as keyof typeof units[typeof category]].name} = {toValue} {units[category][toUnit as keyof typeof units[typeof category]].name}
                  </div>
                </div>
              </div>
            )}
