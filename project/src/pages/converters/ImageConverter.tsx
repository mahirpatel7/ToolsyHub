...
const ImageConverter = () => {
  ...
  const [outputFormat, setOutputFormat] = useState<'jpg' | 'png' | 'webp' | 'bmp' | 'tiff'>('png');
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    To implement this feature, you'll need to integrate with an image processing service
                    like Sharp, ImageMagick, or similar backend solution.
                  </p>
                </div>
              </div>
            </div>
